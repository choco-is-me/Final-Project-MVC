...
INSERT [dbo].[Suppliers] ([SID], [SName], [Phone], [Email], [Address], [Postcode]) VALUES (5, N'Powow Milk Co.', N'(+84) 028 483 5959', N'powmilk@gmail.com', N'283 Nguyen Huu Tho, District 7, HCMC', N'700000')
...
INSERT [dbo].[Products] ([PID], [PName], [Brand], [UnitPrice], [UnitsInStock], [Category], [Description], [SID], [ROL]) VALUES (2, N'Heavy Sugar Milk', N'BB Milk', 5.9900, 300, N'Supplement', N'Milk improve your entire body', 1, 1)
INSERT [dbo].[Products] ([PID], [PName], [Brand], [UnitPrice], [UnitsInStock], [Category], [Description], [SID], [ROL]) VALUES (3, N'Nutella', N'Nutella', 5.9900, 500, N'Supplement', N'Spread the happy!', 1, 1)
INSERT [dbo].[Products] ([PID], [PName], [Brand], [UnitPrice], [UnitsInStock], [Category], [Description], [SID], [ROL]) VALUES (4, N'Pink Cereal', N'Pink Cereal Company', 7.9900, 300, N'Supplement', N'Stays crunchy, even in pink!', 1, 1)
...
INSERT [dbo].[Products] ([PID], [PName], [Brand], [UnitPrice], [UnitsInStock], [Category], [Description], [SID], [ROL]) VALUES (7, N'Light Sugar Milk', N'BB Milk', 5.5900, 500, N'Supplement', N'Now with less sugar!', 1, 1)
INSERT [dbo].[Products] ([PID], [PName], [Brand], [UnitPrice], [UnitsInStock], [Category], [Description], [SID], [ROL]) VALUES (8, N'Nutella Honey', N'Nutella', 9.9900, 100, N'Supplement', N'Looks sweet and good', 1, 1)
INSERT [dbo].[Products] ([PID], [PName], [Brand], [UnitPrice], [UnitsInStock], [Category], [Description], [SID], [ROL]) VALUES (9, N'Go Yogurt', N'BB Milk', 4.9900, 300, N'Supplement', N'Very creamy and delicious', 1, 1)
